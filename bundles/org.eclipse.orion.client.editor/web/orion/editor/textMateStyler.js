...
var RegexUtil = {
	 ...
	 */
	function TextMateStyler(textView, grammar, externalGrammars, preferences, util) {
		this.initialize(textView, preferences, util);
	...
	TextMateStyler.prototype = /** @lends orion.editor.TextMateStyler.prototype */ {
		initialize: function(textView, preferences, util) {
			...
			if (this.textView) {
				...
				self.storageKey = preferences.listenForChangedSettings( this._listener.onStorage );
			}				
		},
...
//				console.debug("{start " + styleRanges[i].start + ", end " + styleRanges[i].end + ", style: " + styleRanges[i].style.styleClass + "}");
	 	...
	 	_updateStylesheet:function(preferences, util){
